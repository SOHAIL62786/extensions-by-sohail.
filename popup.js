...
function getRemarks2(r1,status,data,bid){
    ...
    if(r1 === "-" || r1 === undefined){
        ...
        return "process dropped"
    }else if (r1.toLowerCase().includes("cibil") || r1.toLowerCase().includes("score decline") || r1.toLowerCase().includes("negative area") || r1.toLowerCase().includes("restricted") || r1.toLowerCase().includes("age criteria")){
